...
class DataColumn2 extends DataColumn {
  ...
  const DataColumn2({required super.label, super.tooltip, super.numeric = false, super.onSort, super.headingRowAlignment, this.size = ColumnSize.M, this.fixedWidth, this.minWidth, this.isResizable = false});
...
class DataRow2 extends DataRow {
  ...
  const DataRow2({super.key, super.selected = false, super.onSelectChanged, super.color, this.decoration, required super.cells, this.specificRowHeight, this.onTap, this.onDoubleTap, super.onLongPress, this.onSecondaryTap, this.onSecondaryTapDown, this.rowWrapper});

  DataRow2.byIndex({super.index, super.selected = false, super.onSelectChanged, super.color, this.decoration, required super.cells, this.specificRowHeight, this.onTap, this.onDoubleTap, super.onLongPress, this.onSecondaryTap, this.onSecondaryTapDown, this.rowWrapper}) : super.byIndex();
...
class DataTable2 extends DataTable {
  ...
  Widget build(BuildContext context) {
    ...
    List<TableRow>? coreRows = rows.isEmpty || actualFixedColumns >= columns.length + (showCheckboxColumn ? 1 : 0)
        ? null
        : _buildTableRows(anyRowSelectable, effectiveDataRowColor, context, theme, tableColumnWidths.length - actualFixedColumns, defaultRowColor, actualFixedRows == 0 ? _buildHeadingRow(context, theme, effectiveHeadingRowColor, tableColumnWidths.length - actualFixedColumns) : null, actualFixedRows > 0 ? actualFixedRows - 1 : 0);
    ...
    List<TableRow>? fixedRows = actualFixedRows > 0
        ? (actualFixedRows == 1
            ...
            : [_buildHeadingRow(context, theme, headingRowColor ?? effectiveHeadingRowColor, tableColumnWidths.length - actualFixedColumns), ..._buildTableRows(anyRowSelectable, headingRowColor ?? effectiveDataRowColor, context, theme, tableColumnWidths.length - actualFixedColumns, defaultRowColor, null, 0, actualFixedRows - 1, true)])
        : null;
            ...
            if (rows.isNotEmpty) {
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Flexible(
                        ...
                        child: Scrollbar(
                            ...
                            child: SingleChildScrollView(controller: coreVerticalController, scrollDirection: Axis.vertical, child: SingleChildScrollView(controller: coreHorizontalController, scrollDirection: Axis.horizontal, child: addBottomMargin(coreTable)))))
                  ]));
              ...
              fixedColumnAndCornerCol = fixedTopLeftCornerTable == null && fixedColumnsTable == null
                  ...
                  : Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      if (fixedColumnsTable != null) Flexible(fit: FlexFit.loose, child: ScrollConfiguration(behavior: ScrollConfiguration.of(context).copyWith(scrollbars: false), child: SingleChildScrollView(controller: leftColumnVerticalContoller, scrollDirection: Axis.vertical, child: addBottomMargin(fixedColumnsTable))))
                    ]);
            }
  ...
  List<double> _calculateDataColumnSizes(BoxConstraints constraints, double checkBoxWidth, double effectiveHorizontalMargin, ColumnDataController columnDataController) {
